...
######ChIP-seq
###Read ChIP-seq data
TF<-read.table("C:/Users/ASUS/Desktop/keyan/realdata/TFTARGET/attribute_list_entries.txt",header=T,na.strings = c("NA"))
TF2<-read.table("C:/Users/ASUS/Desktop/keyan/realdata/TFTARGET/attribute_list_entries2.txt",header=T,na.strings = c("NA"))
TF_target<-read.table("C:/Users/ASUS/Desktop/keyan/realdata/TFTARGET/gene_attribute_edges.txt",header=T,na.strings = c("NA"))
TF_target2<-read.table("C:/Users/ASUS/Desktop/keyan/realdata/TFTARGET/gene_attribute_edges2.txt",header=T,na.strings = c("NA"))
